...
df = pd.read_csv('./hyp1.csv', index_col=0)
df_empty = df[0:0]
df_empty.to_csv('hyp1.csv')
...
for z in range(0, 1000, 1):
    ...
    # --- Statistics ---
    # -----------------------------------------------------------------------------------------------
    # Primary model stats: precision, recall, f1_score, support, accuracy, auc, macro_avg_f1, specificity
    ...
    # ------------------------------------------------------------------
    # Add Strategy Metrics: mean, stdev, sr
    ...
    # Comparison Metrics: difference meta - primary for sr, mean, stdev
    ...
    # Classification Metrics: difference meta - primary for recall, prec, acc, f1, auc
